...
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.CJudoParticipantEntry.COLUMN_NAME_DOB;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.CJudoParticipantEntry.TABLE_NAME;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.CJudoParticipantEntry.buildParticipantUri;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.CONTENT_AUTHORITY;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.PATH_CATEGORY;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.PATH_PARTICIPANT;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.PATH_POOL;
import static com.cupertinojudo.android.data.source.local.CJTPersistenceContract.PATH_TOURNAMENT;
