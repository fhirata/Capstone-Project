...
/**
 * Manages "Authentication" to CJC's backend service.  The SyncAdapter framework
 ...
 */
public class CJudoAuthenticator extends AbstractAccountAuthenticator {

    public CJudoAuthenticator(Context context) {
        super(context);
    }
